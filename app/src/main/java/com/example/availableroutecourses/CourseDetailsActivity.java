...
public class CourseDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        course_im=findViewById(R.id.course_imv);
        course_tv=findViewById(R.id.couse_tv);
        Intent intent=getIntent();
        if(intent==null){
            return;
        }
        String course =intent.getStringExtra(Constantes.COURSES);   //المفتاح
        switch (course){
            case Constantes.ANDROID_COURSES:{       //اللى جوا المفتاح
                course_im.setImageResource(R.drawable.android_screen);
                course_tv.setText("Part 1 ( Java SE)\n" +
            ...
            case Constantes.IOS_COURSES:{
                course_im.setImageResource(R.drawable.ios_screen);
                course_tv.setText("\n" +
                        "OOP refreshment\n" +
                        "• Introduction\n" +
            ...
            case Constantes.FULL_STACK_COURSES:{
                course_im.setImageResource(R.drawable.fullstuck_screen);
                course_tv.setText("\n" +
                        "•HTML\t\n" +
                        "•HTML 5 \n" +
                        "•CSS\n" +
